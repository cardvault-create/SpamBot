...
""",
            ...
            if deleted > 0:
                msg_text = f"""
{self.bi('✅ 𝗗𝗘𝗟𝗘𝗧𝗘𝗗: ' + str(deleted) + ' 𝗠𝗲𝘀𝘀𝗮𝗴𝗲𝘀')}
{self.bi('📌 ' + gname)}
"""
            else:
                msg_text = f"""
...
{self.bi('━━━━━━━━━━━━━━')}
{self.bi('⚠ 𝗥𝗲𝗮𝘀𝗼𝗻𝘀:')}
{self.bi('𝟭️ 𝗕𝗼𝘁 𝗻𝗼𝘁 𝗔𝗗𝗠𝗜𝗡')}
{self.bi('𝟮️ 𝗡𝗼 𝗱𝗲𝗹𝗲𝘁𝗲 𝗽𝗲𝗿𝗺𝗶𝘀𝘀𝗶𝗼𝗻')}
{self.bi('𝟯️ 𝗠𝗲𝘀𝘀𝗮𝗴𝗲𝘀 > 𝟰𝟴𝗵𝗿𝘀')}
{self.bi('💡 𝗠𝗮𝗸𝗲 𝗯𝗼𝘁 𝗔𝗗𝗠𝗜𝗡 𝘄𝗶𝘁𝗵 𝗗𝗘𝗟𝗘𝗧𝗘 𝗿𝗶𝗴𝗵𝘁𝘀')}
"""
                ...
                if "flood" in error_str or "too many" in error_str or "retry after" in error_str:
                    ...
                    try:
                        if "retry after" in error_str:
                            wt = int(''.join(filter(str.isdigit, error_str.split("retry after")[1]))) + 1
                    except:
                        pass
